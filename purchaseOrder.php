            ...
            <div class="row">
                ...
                <div class="col-md-8">
                     ...
                     <div class="form-group">
                            ...
                            <select name="productname" id="productname" class="form-control selectpicker <?php echo (!empty($productname_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $productname; ?>" data-live-search="true" onchange="updateInputField1()">
                       ...
                       <div class="form-group">
                        ...
                        <div class="selectbox">
                            ...
                            <select name="suppliername" id="suppliername" class="form-control selectpicker <?php echo (!empty($suppliername_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $suppliername; ?>" data-live-search="true" onchange="updateInputField2()">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="unitprice" id="unitprice" class="form-control <?php echo (!empty($unitprice_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $unitprice; ?>">
                            <span class="invalid-feedback"><?php echo $unitprice_err;?></span>
                        </div>

                        <div class="form-group">
                            <label>Quantity Ordered</label>
                            <input type="text" name="qtyorder" class="form-control <?php echo (!empty($qtyorder_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $qtyorder; ?>">
