...
<div class="container mt-5">
    ...
    <!-- Search Bar -->
    <input type="text" id="searchInput" onkeyup="searchTable()" placeholder="Search for products..." class="form-control mb-3">
    ...
    <div class="modal-content">
      ...
      <form method="post">
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-primary" name="updateQuantity">Update</button>
        </div>
      </form>
    </div>
  </div>
